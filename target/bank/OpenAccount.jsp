    ...
    <div class="container-fluid">
      ...
      <div class="collapse navbar-collapse justify-content-end" id="navbarNav">
        <ul class="navbar-nav align-items-center">
          ...
          <li class="nav-item">
            <a class="nav-link" href="settings"><i class="fas fa-gear"></i> Settings</a>
          </li>
          <li class="nav-item">
    ...
    <div class="row">
      ...
      <div class="col-md-3 col-lg-2 p-0 sidebar d-none d-md-block">
        <nav class="nav flex-column">
          ...
          <a class="nav-link active" href="OpenAccount.jsp"><i class="fas fa-plus-circle"></i> Open Account</a>
          <a class="nav-link" href="accounts"><i class="fas fa-wallet"></i> Accounts</a>
          <a class="nav-link" href="TransferServlet"><i class="fas fa-right-left"></i> Transfers</a>
          <a class="nav-link" href="CardServlet"><i class="fas fa-credit-card"></i> Cards</a>
          <a class="nav-link" href="beneficiaryServlet"><i class="fas fa-users"></i> Beneficiaries</a>
          <a class="nav-link" href="profile"><i class="fas fa-user"></i> Profile</a>
          <a class="nav-link" href="settings"><i class="fas fa-gear"></i> Settings</a>
          <a class="nav-link" href="Support.jsp"><i class="fas fa-headset"></i> Support</a>
        </nav>
      </div>
