...
<head>
  ...
  <title>Accounts Management | Vertex Bank Admin</title>
    ...
    <div class="row">
      <div class="col-md-3 col-lg-2 p-0 sidebar d-none d-md-block">
        <nav class="nav flex-column">
          ...
          <a class="nav-link active" href="AdminAccounts"><i class="bi bi-wallet2"></i> Accounts</a>
                  ...
                  <% if (accounts != null && !accounts.isEmpty()) { %>
                    <% for (Account acc : accounts) { %>
                      <tr>
                        ...
                        <td><strong><%= String.format("%.2f", acc.getBalance()) %></strong></td>
                        <td><%= acc.getCurrency() %></td>
                        <td><span class="badge <%= "ACTIVE".equals(acc.getStatus()) ? "bg-success" : "bg-warning" %>"><%= acc.getStatus() %></span></td>
                      </tr>
                    <% } %>
                  <% } else { %>
